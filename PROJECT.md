...
فازهای ۱ تا ۲۷ تکمیل شده‌اند و اپ **روی سرور زنده است**: `https://app.gcamp.ir`.
...
- **HTTPS واقعی**: TLS در لبهٔ CDN (ابر آروان / پارس‌پک) با گواهی معتبر Let's Encrypt؛ مبدأ با Caddy `tls internal`.
...
- جابه‌جایی دامنه به `app.gcamp.ir`.
