...
>
> **آخرین به‌روزرسانی:** خرداد ۱۴۰۵ (پایان فاز ۱ تا ۲۴؛ شامل اصلاحات بازخورد محصول: امنیت تایمر، استریک، ویدیو در حلقه روزانه، دعوت دوستان). برای کارهای باقی‌مانده به [ROADMAP.md](ROADMAP.md) مراجعه کنید.
...
## ۱۰. گام‌های بعدی توسعه

فازهای ۱ تا ۲۷ تکمیل شده‌اند. کار اصلیِ باقی‌مانده، **استقرار** سرویس‌های وابسته به زیرساخت خارجی است:

- **استقرار سرویس ربات** (`bot/`): با توکن واقعی BotFather + تنظیم `BOT_API_SECRET` مشترک. کد آماده است.
...
- موارد کوچک معوق: SMS واقعی برای OTP، فالوآپ زمان‌بندی‌شده ادمین (۱۹.۵)، انیمیشن‌های Framer Motion.
