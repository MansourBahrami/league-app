    ...
    <div className="flex flex-col gap-5 px-5">
      ...
      <div className="flex items-center justify-between px-1 mt-2">
        <div className="flex items-center gap-1.5">
          ...
          <SectionInfoButton
            title={isFriends ? "رده‌بندی دوستان چطوریه؟" : "رده‌بندی هفتگی چطوریه؟"}
            description="این جدول بر اساس XP هفت روز اخیرت مرتب می‌شه تا همیشه رقابت داغ و عادلانه بمونه."
            points={[
              "هر ۱۵ دقیقه مطالعه تاییدشده، ۱ XP به امتیاز هفتگی‌ات اضافه می‌کنه.",
              "توی لیگ اصلی فقط با هم‌سطح‌های خودت رقابت می‌کنی تا شانس برنده شدن داشته باشی.",
              "توی تب دوستان می‌تونی رفقات رو دعوت کنی و مستقیم باهاشون کل‌کل کنی!"
            ]}
          />
        </div>
      </div>
