        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1 text-right">
            <div className="flex items-center gap-1.5">
              ...
              <SectionInfoButton
                title="کمپ مأموریت"
                description="مأموریتت رو انتخاب کن و کنار هم‌هدف‌هات درس بخون."
                points={[
                  "مأموریت روزانه از همین امروز حساب می‌شه و جایزه‌اش سکه‌ست.",
                  "ثبت‌نام مأموریت هفتگی جمعه باز می‌شه و از شنبه شروع می‌شه.",
                  "جایزهٔ مأموریت هفتگی XP و مداله."
                ]}
              />
            </div>
