...
export default function StreakBar({ streak, studiedToday, canFreeze, freezeCost, coins }: Props) {
  ...
  return (
    <section className="glass-card rounded-xl px-4 py-3 flex items-center gap-3 border-r-4 border-r-tertiary-fixed-dim">
      <span
        className="material-symbols-outlined text-tertiary text-[22px] streak-flame shrink-0"
