        ...
        {entries.map((entry) => (
          <Link
            ...
            className={`flex items-center gap-3 p-3 rounded-xl border transition-all ${
              entry.isCurrentUser
                ? "bg-gradient-to-l from-[#e5eeff] to-[#e1e0ff] border-2 border-[#4648d4]/40 shadow-[0_8px_20px_rgba(70,72,212,0.12)] relative"
                : "bg-white/80 border-[#c7c4d7]/30 hover:border-[#4648d4]/30 cursor-pointer"
            }`}
          >
            {entry.isCurrentUser && (
            ...
            <div className={`w-8 h-8 shrink-0 rounded-full flex items-center justify-center text-[13px] font-extrabold ${
              entry.isCurrentUser ? "bg-[#4648d4] text-white" : "bg-[#e1e0ff] text-[#4648d4]"
            }`}>
