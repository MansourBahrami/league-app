...
export default function MissionCard({ mission, userCoins, isLocked, hasActiveMission, userId }: Props) {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-[20px] border border-white/50 rounded-xl p-5 shadow-[0_4px_14px_rgba(70,72,212,0.07)] flex flex-col justify-between relative overflow-hidden">
      ...
      <div>
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex flex-col items-end">
            ...
            <div className="flex items-center gap-1 text-[#4648d4] text-[17px] font-bold">
        ...
        <h3 className="text-[16px] font-bold text-[#0b1c30] mb-2">{mission.targetHours} ساعت مطالعه هفتگی</h3>
