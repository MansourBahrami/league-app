    ...
    <section className="glass-card rounded-xl p-6 flex flex-col gap-4">
      <div className="flex justify-between items-center w-full">
        <div className="flex items-center gap-1.5">
          ...
          <SectionInfoButton
            title="مدال‌های مطالعه و ارتقای سطح"
            description="با برداشتن ماموریت هفتگی در اتاق ماموریت و رسیدن به ساعت هدف، مدال اختصاصی آن هفته را دریافت می‌کنی."
            points={[
              "مدال‌ها برای ارتقای سطح و گرفتن ستاره‌های بالاتر الزامی هستند.",
              "هر ماموریت هفتگی بر اساس ساعتی که انتخاب می‌کنی (مثلاً ۲۰، ۳۰، ۵۰ ساعت و...) مدال جداگانه دارد."
            ]}
          />
        </div>
