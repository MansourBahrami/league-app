    ...
    <section className="glass-card rounded-xl p-6 flex flex-col gap-4">
      <div className="flex justify-between items-center w-full">
        <div className="flex items-center gap-1.5">
          ...
          <SectionInfoButton
            title="مدال‌ها به چه دردی می‌خورن؟"
            description="مدال‌ها دستاوردهای خفن هفتگی‌ات هستن! وقتی توی اتاق مأموریت یک هدف هفتگی برمی‌داری و تا آخر هفته کاملش می‌کنی، مدال اون ساعت رو می‌گیری."
            points={[
              "برای رفتن به سطح‌های بالاتر و گرفتن ستاره، فقط XP کافی نیست؛ باید مدال‌های مشخصی هم داشته باشی.",
              "هر چی ساعت مأموریت هفتگی‌ات بیشتر باشه، مدال باارزش‌تری گیرت میاد."
            ]}
          />
        </div>
