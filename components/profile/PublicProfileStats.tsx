...
export default function PublicProfileStats({ xp, coins, rank, totalUsers }: Props) {
  const stats = [
    {
      label: "امتیاز",
      value: xp.toLocaleString("fa-IR"),
      unit: "XP",
      icon: "bolt",
    ...
    {
      label: "سکه",
      value: coins.toLocaleString("fa-IR"),
      unit: "موجودی",
      icon: "paid",
  ...
  return (
    <section className="grid grid-cols-3 gap-2" aria-label="خلاصه عملکرد کاربر">
      {stats.map((stat) => (
