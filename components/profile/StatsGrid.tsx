  ...
  return (
    <section className="grid grid-cols-2 gap-2">
      <div className="glass-card rounded-xl p-4 flex flex-col items-center text-center gap-2">
        ...
        <p className="text-[20px] font-bold text-[#0b1c30]">{totalHours.toLocaleString("fa-IR")} <span className="text-[16px] font-normal">ساعت</span></p>
      </div>
      <div className="glass-card rounded-xl p-4 flex flex-col items-center text-center gap-2">
      ...
      <div className="glass-card rounded-xl p-4 flex items-center gap-3 col-span-2">
        ...
        <div className="text-right">
          ...
          <p className="text-[20px] font-bold text-[#0b1c30]">جایگاه {rank.toLocaleString("fa-IR")} از {totalUsers.toLocaleString("fa-IR")}</p>
        </div>
      </div>
    </section>
  );
